...
namespace Uli.Extensions
{
    public static class ExtensionMethods
    {
        ...
        {
            return Mathf.FloorToInt(Random.Range(0, list.Count));
        }
        public static int GetRandomIndex<T>(this T[] array)
        {
            return Mathf.FloorToInt(Random.Range(0, array.Length));
        }
        ...
        /// <summary>
        /// Seta a ancora de um rectransform como no editor
        /// </summary>
        ...
        /// <summary>
        /// Seta o pivor de um recttransform como no editor
        /// </summary>
        /// <param name="source"></param>
    ...
    {
        /// <summary>
        /// Maps a value from a min/max value to another min/max value
        /// </summary>
        /// <param name="x"></param>
